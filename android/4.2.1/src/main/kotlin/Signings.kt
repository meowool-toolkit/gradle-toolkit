 ...
 */
fun Project.debugSigning(configuration: SigningConfig.() -> Unit) {
  android {
 ...
 */
fun Project.releaseSigning(configuration: SigningConfig.() -> Unit) {
  android {
 ...
 */
fun Project.signing(configuration: SigningConfig.() -> Unit) {
  android {
    val config = "_#all#"
    signingConfigs {
      create(config) {
        loadSigningConfigPresets(this)
        configuration()
      }
    }
    buildTypes {
