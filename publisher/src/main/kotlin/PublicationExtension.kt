...
class PublicationExtension(internal val project: Project) {
   ...
   *
   * Note that when this value has not been modified, this value defaults to the value of the parent project.
   */
  var showIncompatibleWarnings: Boolean? = null
    get() = field ?: project.parentPublication?.showIncompatibleWarnings ?: true

  /**
   * The data of the publication.
   */
   ...
   *
   * If this value is `null`, it means this is a Maven publication, otherwise the publication will be regarded
   * as a Gradle plugin.
   *
   * @see PublicationData
  ...
  /**
   * The destinations of the publication to publishing to.
   *
  ...
  /**
   * The destination where the local version of the publication will be published.
   *
   * Note that this value will inherit the value set in the parent project.
   *
   * @see isLocalVersion
   ...
   *
   * Note that this value will initially use the value set in the parent project.
   */
