 ...
 */
internal class DependencyMapperExtensionImpl(project: Project) : DependencyMapperExtension(project) {
  @Volatile
  ...
  private val outputFile get() = cacheDir.resolve("${System.currentTimeMillis()}.jar").also { output ->
