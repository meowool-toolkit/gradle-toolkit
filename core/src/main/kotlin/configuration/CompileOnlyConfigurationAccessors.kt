...
/**
 * Adds a project dependency to the 'compileOnly' configuration.
 *
 ...
 * @see [addDependencyTo]
 */
fun DependencyHandler.compileOnlyProject(
  projectPath: CharSequence,
  dependencyConfiguration: Action<ExternalModuleDependency>
): ExternalModuleDependency = addDependencyTo(
  this, "compileOnly", project(projectPath.toString()), dependencyConfiguration
)
 ...
 */
fun DependencyHandler.compileOnlyProject(projectPath: CharSequence): Dependency? =
  add("compileOnly", project(projectPath.toString()))
